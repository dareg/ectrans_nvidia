...
USE TPM_FIELDS            ,ONLY : FIELDS_RESOL, F,F_RW, F_RN, F_RLAPIN, F_RACTHE, ZIA,ZEPSNM,ZSOA1,ZAOA1,ZAIA,ZOA1,ZOA2, &
...
INTEGER(KIND=JPIM) :: JMLOC, KM, ILA, ILS, KMLOC, KDGLU, JK, i, J, IF_FS, IF_OUT_LT, IF_UV, IF_SCALARS
...
!$ACC& COPYIN(TDZAA,ILDZCA,ILDZBS,ILDZCS)
...
!#endif
!#ifdef OMPGPU
!!$OMP TARGET ENTER DATA MAP(PRESENT,ALLOC:FOUBUF_IN,FOUBUF)
!#endif
!FOUBUF_IN(:)=0._JPRBT
!#ifdef ACCGPU
...
!#endif
!#ifdef OMPGPU
!!$OMP TARGET UPDATE TO(FOUBUF_IN)
!#endif
!FOUBUF(:)=0._JPRBT
!#ifdef ACCGPU
